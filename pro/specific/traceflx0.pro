...
!p.multi=[0,1,3] & printcap,'traceflx0',3

for ip=1,3,1 do begin			;{begin pressure loop
  ...
  ;
  plot,tlog,f173,title='TRACE [173A]; logP='+strtrim(logP,2),$
	xtitle='log!d10!n(T [K])',ytitle='[DN]',/yl,$
  ...
  ;
  plot,tlog,f195,title='TRACE [195A]; logP='+strtrim(logP,2),$
	xtitle='log!d10!n(T [K])',ytitle='[DN]',/yl,$
	subtitle='EM='+string(EM,'(g7.2)')+' [cm!u-5!n]'
  ...
  ;
  plot,tlog,f284,title='TRACE [284A]; logP='+strtrim(logP,2),$
	xtitle='log!d10!n(T [K])',ytitle='[DN]',/yl,$
	subtitle='EM='+string(EM,'(g7.2)')+' [cm!u-5!n]'
endfor					;IP=1,3,1}
