function str2arr,str,delim,sep=sep,i1=i1,i4=i4,r4=r4,r8=r8,$
...
message,'Obsolete; superseded by STR_2_ARR()',/informational

;	usage
ns=n_elements(str)
if ns eq 0 then begin
  print,'Usage: arr=str2arr(str,delim,sep=sep,/I1,/I4,/R4,/R8,/squish,$'
