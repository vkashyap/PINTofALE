pro ti_or,tstr1,tstp1,tstr2,tstp2,tstart,tstop, _extra=e
;+
;procedure	ti_or
...
if n1 eq 0 or n2 eq 0 or m1 eq 0 or m2 eq 0 then begin
  print,'Usage: ti_or,tstr1,tstp1,tstr2,tstp2,tstart,tstop'
...
oo=where(ii gt 0,moo) & if moo eq 0 then message,'bug!'
;
